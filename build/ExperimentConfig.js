    ...
    return (
        React.createElement("div", {className: "panel panel-info col-xs-12"}, 
                      ...
                      React.createElement("div", {className: "panel body"}, 
                        React.createElement("a", {className: "btn btn-primary", onClick: this.addCentring}, React.createElement("i", {className: "fa fa-fw fa-plus-square"}), "Centring"), 
                        React.createElement("a", {className: "btn btn-primary", onClick: this.addCharacterisation}, React.createElement("i", {className: "fa fa-fw fa-plus-square"}), "Characterisation"), 
                        React.createElement("a", {className: "btn btn-primary", onClick: this.addStandardCollection}, React.createElement("i", {className: "fa fa-fw fa-plus-square"}), "Standard Collection"), 
